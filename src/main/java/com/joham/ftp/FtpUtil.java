...
public class FtpUtil {
    ...
    public static String pictureUploadByConfig(FtpConfig ftpConfig, String picNewName, String picSavePath,
        ...
        picHttpPath = ftpConfig.getImageBaseUrl() + picSavePath + "/" + picNewName;
     ...
     */
    public static boolean uploadFile(String host, int ftpPort, String username, String password, String basePath,
